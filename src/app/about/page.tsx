...
export default function About() {
        ...
        <Wrapper>
            <section className="bg-[#074643]  h-full  text-white text-center">
                <div className="text-center space-y-4">
                    <h1 className=" md:text-3xl font-bold md:mb-10 text-yellow-400 text-xl pt-28 md:pt-24">About Me</h1>
                    <h2 className="text-lg font-semibold sm:text-xl md:text-2xl lg:text-2xl">Hey there!</h2>
                    <h3 className="text-lg font-semibold sm:text-xl md:text-2xl lg:text-2xl">My name is Aqsa Iqbal</h3>
                    <h3 className="text-lg font-semibold sm:text-xl md:text-2xl lg:text-2xl">I&apos;m 23 years old</h3>
                    <p className="text-sm font-semibold sm:text-xl md:text-2xl lg:text-2xl">
  ...
  <h2 className="text-xl font-bold mb-5 text-yellow-400 py-8 md:text-4xl">My Skill&apos;s</h2>
  <div className="grid grid-cols-2 gap-3 w-36  mx-auto pb-14 justify-center items-center  md:grid-cols-6 md:w-2/4 md:pb-5 md:gap-2 lg:w-3/4 lg:gap-1 lg:pb-7">
    ...
    <Image src="/js.png" alt="JavaScript" width={90} height={50} className="hover:scale-110 duration-300" />
