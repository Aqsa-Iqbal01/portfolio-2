  ...
  return (
    <Wrapper>
      <section className="bg-[#074643] h-screen text-white flex flex-col items-center justify-center text-center p-6">
        <h1 className="text-xl font-bold my-5 text-yellow-400 sm:text-2xl md:text-3xl lg:text-3xl hover:scale-110 transition duration-300 cursor-pointer">Let’s Connect!</h1>
        <p className="text-md mb-4 font-sans sm:text-xl md:text-2xl lg:text-2xl">
          Have a project in mind? Let’s build something great together!
        </p>
        <p className="text-md mb-4 font-sans sm:text-lg md:text-xl lg:text-xl">Contact Me on social media</p>
        ...
        {/* Brief Introduction */}
        <p className="text-md mb-5 font-sans sm:text-lg md:text-xl lg:text-xl">
